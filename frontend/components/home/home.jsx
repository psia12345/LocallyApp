...
const Home = () => (
  <div>
    ...
    <div className="category-browse">
      <div className="row1">
        <div className="category-square" style={{backgroundImage: 'url( http://res.cloudinary.com/psia12345/image/upload/c_scale,w_700/v1478499010/photo-1445205170230-053b83016050_ujlcre.jpg)'}}>
          <h4>Clothing</h4>
        </div>
